...
class ChokeDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const ChokeDetails({super.key, required this.scaffoldKey});

  @override
  State<ChokeDetails> createState() => _ChokeDetailsState();
}

class _ChokeDetailsState extends State<ChokeDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/choking/adult-choking/';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Choke Casualty...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaidchoke.jpg', // Replace with your image asset path

...
class FaintingDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const FaintingDetails({super.key, required this.scaffoldKey});

  @override
  State<FaintingDetails> createState() => _FaintingDetailsState();
}

class _FaintingDetailsState extends State<FaintingDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/unresponsive-casualty/fainting/#:~:text=If%20someone%20faints%3A,fresh%20air%20and%20monitor%20them.';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Fainting Casualty...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaidfainting.jpg', // Replace with your image asset path

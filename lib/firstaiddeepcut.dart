...
class DeepCutDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const DeepCutDetails({super.key, required this.scaffoldKey});

  @override
  State<DeepCutDetails> createState() => _DeepCutDetailsState();
}

class _DeepCutDetailsState extends State<DeepCutDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/minor-illnesses-and-injuries/cuts-and-grazes/';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Deep Cut/ Scrap injury...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaiddeepcut.jpg', // Replace with your image asset path

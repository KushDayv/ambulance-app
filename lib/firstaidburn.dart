...
class BurnDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const BurnDetails({super.key, required this.scaffoldKey});

  @override
  State<BurnDetails> createState() => _BurnDetailsState();
}

class _BurnDetailsState extends State<BurnDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/effects-of-heat-and-cold/burns-and-scalds/';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Burn injury...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaidburn.png', // Replace with your image asset path

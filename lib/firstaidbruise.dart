...
class BruiseDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const BruiseDetails({super.key, required this.scaffoldKey});

  @override
  State<BruiseDetails> createState() => _BruiseDetailsState();
}

class _BruiseDetailsState extends State<BruiseDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/minor-illnesses-and-injuries/bruising/#:~:text=can%20bruise%20easily.-,What%20to%20do,for%20at%20least%2020%20minutes.';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Bruise injury...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaidbruise.jpg', // Replace with your image asset path

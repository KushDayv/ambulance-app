...
class FractureDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const FractureDetails({super.key, required this.scaffoldKey});

  @override
  State<FractureDetails> createState() => _FractureDetailsState();
}

class _FractureDetailsState extends State<FractureDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/bones-and-muscle-injuries/broken-bones-and-fractures/';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Fracture injury...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaidfracture.png', // Replace with your image asset path

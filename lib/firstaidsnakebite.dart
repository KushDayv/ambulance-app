...
class SnakeBiteDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const SnakeBiteDetails({super.key, required this.scaffoldKey});

  @override
  State<SnakeBiteDetails> createState() => _SnakeBiteDetailsState();
}

class _SnakeBiteDetailsState extends State<SnakeBiteDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/minor-illnesses-and-injuries/animal-bites/';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Snake Bite injury...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaidsnakebite.jpg', // Replace with your image asset path

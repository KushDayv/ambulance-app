...
class DislocationDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const DislocationDetails({super.key, required this.scaffoldKey});

  @override
  State<DislocationDetails> createState() => _DislocationDetailsState();
}

class _DislocationDetailsState extends State<DislocationDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/bones-and-muscle-injuries/dislocated-joints/';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Dislocation injury...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaiddislocation.png', // Replace with your image asset path

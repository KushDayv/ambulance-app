...
class FoodPoisoningDetails extends StatefulWidget {
  final GlobalKey<ScaffoldMessengerState> scaffoldKey;

  const FoodPoisoningDetails({super.key, required this.scaffoldKey});

  @override
  State<FoodPoisoningDetails> createState() => _FoodPoisoningDetailsState();
}

class _FoodPoisoningDetailsState extends State<FoodPoisoningDetails> {
  final url = 'https://www.sja.org.uk/get-advice/first-aid-advice/poisoning/food-poisoning/';
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            color: Colors.blueGrey, // Blue background color
            child: const Text(
              'Instructions on how to treat a Food Poisoning Casualty...',
          ...
          Expanded(
            child: ClipRRect( // Wrap the image with ClipRRect to avoid overflow
              ...
              child: Image.asset(
                'assets/firstaidfoodpoisoning.jpg', // Replace with your image asset path
